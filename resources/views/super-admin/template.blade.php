            ...
            <nav class="navbar navbar-expand-lg px-4">
                <div class="container-fluid">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="text-uppercase fw-semibold fs-6 mb-0 mobile-header-text">SuperAdmin Panel</span>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-lg-none">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-dark fw-semibold {{ request()->routeIs('sa.admin.index') ? 'active' : '' }}" href="{{ route('sa.admin.index') }}">Admins</a>
                            </li>
                            <li class="nav-item">
